...
<body>
	...
	<?php
		...
		$no_accept_count = mysql_query("SELECT * FROM table_reviews WHERE moderate = '0'",$link);
...
if ($row["moderate"] == '0'){ $link_accept = '<a class="green" href="reviews.php?id='.$row["reviews_id"].'&action=accept" >Принять</a> | '; } else { $link_accept = ''; }
