...
<div id="block-parfume">
	...
	<ul>
		<li><a id="index1"><img src="/images/mans-parfume.png" id="mans-parfume">Мужчинам</a>
		...
		<li><a id="index2"><img src="/images/womans-parfume.png" id="womans-parfume">Женщинам</a>
			<ul class="category-section">
